...
#    And Es wird bestätigt, dass die gespeicherte 'Remote Units' aufgelistet wurde.
  ...
  Scenario: TC_11_01 Der Benutzer sollte  die Schaltfläche "Add New Remote Unit" anzeigen.
    And Klick auf die Schaltflueche "acilirOk".
    And Der Benutzer klickt auf den Reiter 'Remote Units'.
    And Der Benutzer sieht auf den Reiter 'Add New Remote Units' an.
  ...
  @US_12
  Scenario: TC_12_14 Auf der Seite Edit Remote Unit wird ein Warntext angezeigt, wenn das Formular gespeichert wird, ohne das Feld "Name" auszufüllen.
